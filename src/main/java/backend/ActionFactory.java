...
public class ActionFactory {
    public static Action createAction(int type, String content,String connectionID) {
        ...
        if(type == ACTION_RECEIVE_CONNECTION_REQUEST) return new ActionReceiveConnectionRequest(content,connectionID);
        ...
        if(type==ACTION_RECEIVE_FILE_TRANSMISSION_INTENT) return new ActionReceiveFileTransmissionIntent(content,connectionID);
        return null;
    }
